...
from src.helpers.paths import PARENT_DIR

# load key-value pairs from .env file located in the parent directory
load_dotenv(PARENT_DIR / '.env')

HOPSWORKS_PROJECT_NAME = 'ml0001'
...
def get_historical_rides() -> pd.DataFrame:
    ...
    import pandas as pd
    from src.helpers.data import load_raw_data
...
def run():
    ...
    from src.helpers.data import transform_raw_data_into_ts_data
